...
#   timestamp: 2023-01-01T19:23:33+00:00
...
class DefaultEquityOrderLegInstruction(Enum):
    BUY = 'BUY'
    SELL = 'SELL'
...
class DefaultEquityOrderType(Enum):
    MARKET = 'MARKET'
    LIMIT = 'LIMIT'
    STOP = 'STOP'
...
class DefaultEquityOrderPriceLinkType(Enum):
    VALUE = 'VALUE'
    PERCENT = 'PERCENT'
    NONE = 'NONE'


class DefaultEquityOrderDuration(Enum):
    DAY = 'DAY'
    GOOD_TILL_CANCEL = 'GOOD_TILL_CANCEL'
    NONE = 'NONE'


class DefaultEquityOrderMarketSession(Enum):
    AM = 'AM'
    PM = 'PM'
    NORMAL = 'NORMAL'
    SEAMLESS = 'SEAMLESS'
...
class MutualFundTaxLotMethod(Enum):
    FIFO = 'FIFO'
    LIFO = 'LIFO'
    HIGH_COST = 'HIGH_COST'
    LOW_COST = 'LOW_COST'
